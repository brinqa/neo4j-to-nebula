 ...
 *
 * <p>Streams of records are returned from Cypher query execution, contained within a {@link
 * Result}.
 *
 * <p>A record is a form of ordered map and, as such, contained values can be accessed by either
 * positional {@link #get(int) index} or textual {@link #get(String) key}.
 *
 * @since 1.0
 */
@Immutable
