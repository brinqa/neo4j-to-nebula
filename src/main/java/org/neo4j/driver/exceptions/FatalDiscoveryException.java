...
/**
 * This error indicate a fatal problem to obtain routing tables such as the routing table for a
 * specified database does not exist. This exception should not be retried.
 *
 * @since 4.0
 */
