...
/**
 * This is the base class for all exceptions caused as part of communication with the remote Neo4j
 * server.
 *
 * @since 1.0
 */
public abstract class Neo4jException extends RuntimeException {
  ...
  /**
   * Access the standard Neo4j Status Code for this exception, you can use this to refer to the
   * Neo4j manual for details on what caused the error.
   *
  ...
  /**
   * Access the status code for this exception. The Neo4j manual can provide further details on the
