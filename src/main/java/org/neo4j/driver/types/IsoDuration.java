...
/**
 * Represents temporal amount containing months, days, seconds and nanoseconds of the second. A
 * duration can be negative.
 *
 * <p>Value that represents a duration can be created using {@link Values#isoDuration(long, long,
 * long, int)} method.
 */
@Immutable
