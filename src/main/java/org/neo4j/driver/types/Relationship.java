...
/**
 * The <strong>Relationship</strong> interface describes the characteristics of a relationship from
 * a Neo4j graph.
 *
 * @since 1.0
 */
public interface Relationship extends Entity {
   ...
   * @return {@code true} if this relationship has the given relationship type otherwise {@code
   *     false}
   */
